        ...
        <ul class="contact__details">
          ...
          <li class="contact__detail">
            <div class="contact__detail-icon">
              <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 2a5.5 5.5 0 0 0-5.5 5.5c0 4.125 5.5 10.5 5.5 10.5s5.5-6.375 5.5-10.5A5.5 5.5 0 0 0 10 2z" stroke="currentColor" stroke-width="1.5" fill="rgba(255,255,255,0.1)"/>
          ...
          <li class="contact__detail">
            ...
            <div>
              ...
              <a href="mailto:contact@zpdilyanvelev.bg" class="contact__detail-value contact__detail-value--link">
                contact@zpdilyanvelev.bg
              </a>
            </div>
          </li>
          ...
          <li class="contact__detail">
            <div class="contact__detail-icon">
              <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.5 13.8l-2.5-1.1c-.3-.1-.6 0-.8.2l-1.1 1.3c-1.9-.9-3.4-2.4-4.3-4.3l1.3-1.1c.2-.2.3-.5.2-.8L7.2 5.5c-.1-.3-.4-.5-.7-.5H4c-.3 0-.6.1-.8.4C2.8 6.7 2.5 9.6 4.5 12.5c1.8 2.6 4.8 4.1 8 3.5.4-.1.6-.4.5-.8V14.5c0-.3-.2-.6-.5-.7z" stroke="currentColor" stroke-width="1.4" fill="rgba(255,255,255,0.1)" stroke-linejoin="round"/>
              </svg>
            </div>
            <div>
              <span class="contact__detail-label">{{ tr.contact.phoneLabel }}</span>
              <a href="tel:+359000000000" class="contact__detail-value contact__detail-value--link">
                +359 (0) 000 000 000
              </a>
            </div>
          </li>
          ...
          <form v-else class="contact__form" novalidate @submit.prevent="submit">
            ...
            <div class="form-row">
              <div class="form-field" :class="{ 'has-error': errors.name }">
                ...
                <input id="c-name" v-model="form.name" type="text" class="form-input"
                  :placeholder="tr.contact.form.namePlaceholder" autocomplete="name"/>
              ...
              <div class="form-field" :class="{ 'has-error': errors.email }">
                ...
                <input id="c-email" v-model="form.email" type="email" class="form-input"
                  :placeholder="tr.contact.form.emailPlaceholder" autocomplete="email"/>
            ...
            <div class="form-field">
              ...
              <input id="c-phone" v-model="form.phone" type="tel" class="form-input"
                :placeholder="tr.contact.form.phonePlaceholder" autocomplete="tel"/>
            </div>
            ...
            <div class="form-field" :class="{ 'has-error': errors.message }">
              ...
              <textarea id="c-message" v-model="form.message" class="form-input form-textarea"
                :placeholder="tr.contact.form.messagePlaceholder" rows="5"></textarea>
...
.contact {
  ...
  background:
    radial-gradient(ellipse at 20% 50%, rgba(42, 77, 20, 0.25) 0%, transparent 60%),
    linear-gradient(160deg, #100c08 0%, #18090b 60%, #100a0a 100%);
}
...
.contact__heading em { font-style: italic; color: var(--color-cherry-light); }
...
.contact__details { list-style: none; display: flex; flex-direction: column; gap: 20px; margin-bottom: 32px; }
...
.contact__detail-icon svg { width: 17px; height: 17px; }

.contact__detail > div { display: flex; flex-direction: column; gap: 2px; padding-top: 2px; }
...
.contact__detail-value { font-size: 14px; color: rgba(255,255,255,0.72); }
.contact__detail-value--link { transition: color 0.2s; }
.contact__detail-value--link:hover { color: #fff; }
...
.contact__map-link svg { width: 15px; height: 15px; flex-shrink: 0; }
.contact__map-link .arrow { margin-left: auto; transition: transform 0.2s; }
.contact__map-link:hover { color: #fff; background: rgba(255,255,255,0.08); }
.contact__map-link:hover .arrow { transform: translateX(3px); }
...
.form-label { font-size: 13px; font-weight: 500; color: rgba(255,255,255,0.55); letter-spacing: 0.01em; }
.form-label span[aria-hidden] { color: var(--color-cherry-light); margin-left: 2px; }
.form-optional { font-size: 12px; font-weight: 400; color: rgba(255,255,255,0.28); }
...
.form-input:focus { border-color: var(--color-cherry-light); background: rgba(255,255,255,0.09); }
.has-error .form-input { border-color: rgba(255,100,100,0.60); }
.form-textarea { min-height: 120px; line-height: 1.6; }
.form-error { font-size: 12.5px; color: rgba(255,140,140,0.90); }
...
.form-submit:not(:disabled):hover svg { transform: translateX(3px); }
...
/* Success */
.contact__success { display: flex; flex-direction: column; align-items: center; text-align: center; padding: 24px 0; }
.contact__success-icon { margin-bottom: 24px; }
.contact__success-icon svg { width: 64px; height: 64px; }
.contact__success-title { font-family: var(--font-display); font-size: 28px; font-weight: 600; color: #fff; margin-bottom: 12px; }
.contact__success-body { font-size: 15px; color: rgba(255,255,255,0.55); line-height: 1.7; margin-bottom: 32px; max-width: 280px; }
.contact__success-btn { padding: 10px 24px; font-size: 14px; font-weight: 600; color: rgba(255,255,255,0.70); background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-radius: var(--radius); transition: background 0.2s, color 0.2s; }
.contact__success-btn:hover { background: rgba(255,255,255,0.13); color: #fff; }
